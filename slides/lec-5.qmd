...
## Median - Scenario 1 {.scrollable .smaller}

One example of a research study that used the median instead of the mean when reporting results is a study that examined the income of a group of people. In this study, the researchers may have chosen to report the median income instead of the mean income because the income distribution may have been skewed.

For example, let's say the researchers surveyed 100 people and found that 90 of them had an income of \$50,000 per year, 5 of them had an income of \$100,000 per year, and 5 of them had an income of \$500,000 per year. In this case, the mean income would be calculated as (90 x 50,000 + 5 x 100,000 + 5 x 500,000) / 100 = \$83,000 per year. However, this value may not be representative of the income of the majority of the participants because it is heavily influenced by the small group of high earners.

Instead, the researchers may choose to report the median income, which is the middle value of the income distribution when the values are arranged in order. In this example, the median income would be \$50,000 per year, which is a more representative value of the income of the majority of the participants.

## Median - Scenario 2 {.scrollable .smaller}

Below is an example of a `fictitious study` where the authors would have chosen the median instead of the mean to report their results.

Title: "The relationship between physical activity and depression in adults with multiple sclerosis"

In this study, the researchers investigated the relationship between physical activity and depression in adults with multiple sclerosis (MS). They collected data on physical activity levels and depression scores from 60 adults with MS and reported the results using the median instead of the mean.

Specifically, they reported the median number of minutes per day that participants engaged in moderate-to-vigorous physical activity (MVPA) and the median score on the Center for Epidemiologic Studies Depression Scale (CES-D). They also used the median split technique to categorize participants into high and low MVPA groups and compared their depression scores.

Using the median instead of the mean is appropriate in this case because the physical activity and depression data were not normally distributed and were skewed towards lower levels of physical activity and higher depression scores. The use of the median allows for a more accurate representation of the typical physical activity level and depression score in this population.
...
-   Example of using mode in a study on exercise habits in older adults
