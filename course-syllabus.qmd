...
I will adopt the 4 "Ps"[^2] in this course. This means that while taking this course you will be asked to `prepare`, `participate`, `practice`, and `perform`.

[^2]: Inspired by Mine Çetinkaya-Rundel teaching philosophy.

You are responsible for the material covered in the textbook prior to attending each class. Note that the week's readings are specified in the [course schedule](index.qmd).
